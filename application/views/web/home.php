          ...
          <div class="row">
            <div class="col-xl-2 col-lg-4 col-md-4 col-sm-3 col logo_section">
              <div class="full">
                <div class="center-desk">
                  <div class="logo">
                    <a href=""><img class="h-80px" src="<?= base_url() ?>assets/web/images/logo2.png" alt="#" /></a>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-xl-10 col-lg-8 col-md-8 col-sm-9">
              <div class="header_information">
                ...
                <div class="mean-last">
                  <a href="#"><img src="<?= base_url() ?>assets/web/images/search_icon.png" alt="#" /></a> <a href="#">login</a>
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="carousel-caption">
                  <div class="row align-items-center">
                    <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
                      <div class="text-bg">
                        <h1>Find your Favorite Restaurant in Cinere</h1>
                        <p>A COLLECTION OF RESTAURANTS IN KECAMATAN CINERE</p>
                        <a href="#">Read more</a> <a href="#important">see map</a>
                      </div>
                    </div>
                    <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12">
                      <div class="images_box">
                        <figure><img src="<?= base_url() ?>assets/web/images/img3.png"></figure>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <div class="row">
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
          <div class="about-box">
            ...
            <p> Kami adalah website interaktif yang bertujuan untuk membantu masyarakat menemukan tempat makan terbaik di Kecamatan Cinere. Dengan fokus pada keakuratan data dan kemudahan penggunaan, kami memberikan solusi inovatif bagi pengguna untuk menjelajahi berbagai pilihan kuliner. Platform ini dirancang untuk memberikan pengalaman terbaik dengan peta interaktif, jadwal buka setiap restoran dan kategori lengkap yang memudahkan pencarian berdasarkan jenis masakan. Kami percaya bahwa setiap pengalaman kuliner memiliki cerita, dan kami di sini untuk membantu Anda menemukannya. </p>
  ...
  <div id="important" class="important">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div class="titlepage">
            <h2>Restaurant <strong class="yellow">Location</strong></h2>
            <span>Melalui Peta dibawah anda bisa menemukan berbagai restoran di Kecamatan Cinere berdasarkan lokasinya</span>
          </div>
        </div>
      </div>
    </div>
    <div class="important_bg">
      <div class="container">
        <!-- memangil web -->
        <iframe src="<?= base_url() ?>/home"></iframe>
      </div>
    </div>
  </div>
  </div>
    ...
    <div class="footer ">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-12">
            <h2>Restaurant Cinere</h2>
            <span>Website interaktif yang bertujuan untuk membantu masyarakat menemukan tempat makan terbaik di Kecamatan Cinere. </span>
          </div>
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 ">
            <div class="row">
              <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 ">
                <div class="address">
                  ...
                  <ul class="loca">
                    <li>
                      <a href="#"><img src="<?= base_url() ?>assets/web/icon/loc.png" alt="#" /></a>Cinere
                      <br>Depok
                    </li>
                    <li>
                      <a href="#"><img src="<?= base_url() ?>assets/web/icon/email.png" alt="#" /></a>farhanfadhilahr<br>@gmail.com
                    </li>
                    <li>
                      <a href="#"><img src="<?= base_url() ?>assets/web/icon/call.png" alt="#" /></a>+628568820489
                    </li>
                  </ul>
              ...
              <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="address">
                  ...
                  <ul class="Menu_footer">
                    <li class="active"> <a href="#">Restoran Cepat Saji</a> </li>
                    <li><a href="#">Kafe</a> </li>
                    <li><a href="#">Restoran Asia</a> </li>
                    <li><a href="#">Restoran Bebek dan Ayam</a> </li>
                    <li><a href="#">Restoran Tegal</a> </li>
                  </ul>
                </div>
              </div>
              <div class="col-lg-3 col-md-6 col-sm-6">
              ...
              <div class="col-lg-3 col-md-6 col-sm-6 ">
                <div class="address">
                  <a href=""> <img src="<?= base_url() ?>assets/web/images/logo3.png" alt="logo"></a>
                </div>
              </div>
            </div>
          </div>
